...
//{
//    [Fact]
//    public async Task GetQuestionsFilteredAdvancedAsync_ShouldReturnFilteredQuestions()
//    {
//        // Arrange
//        var mockDbSet = new Mock<DbSet<Question>>();
//        var mockContext = new Mock<ApplicationDbContext>();
//        var mockMapper = new Mock<IMapper>(); // Mock the IMapper dependency

//        mockContext.Setup(c => c.Questions).Returns(mockDbSet.Object);

//        var repository = new QuestionRepository(mockContext.Object, mockMapper.Object); // Provide mocked IMapper

//        int professorId = 1;
//        List<int> questionTypeIds = new List<int> { 1, 2 };
//        List<int> difficultyLevelIds = new List<int> { 1 };
//        int? categoryId = 1;
//        int? courseId = null;
//        List<int> lectureIds = new List<int> { 3, 4 };

//        // Act
//        var result = await repository.GetQuestionsFilteredAdvancedAsync(
//            professorId, questionTypeIds, difficultyLevelIds, categoryId, courseId, lectureIds);

//        // Assert
//        Assert.NotNull(result);
//        Assert.IsType<QuestionFilterResultDto>(result);
//    }
//}
